...
public class OpenCartHomePage extends TestBase {
	...
	@FindBy(xpath = ObjectRepository.firstFeaturedProductAddToCartXpath)
	@CacheLookup
	WebElement firstFeaturedProductAddToCart;
	
	@FindBy(xpath = ObjectRepository.firstFeaturedProductAddToWishlistXpath)
	@CacheLookup
	WebElement firstFeaturedProductAddToWishlist;
	
	@FindBy(xpath = ObjectRepository.firstFeaturedProductCompareXpath)
	@CacheLookup
	WebElement firstFeaturedProductCompare;
	...
	public void ValidateFirstFeaturedProduct() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(firstFeaturedProductAddToCart));
		firstFeaturedProductAddToCart.click();
		System.out.println("First Featured Product is successfully added to cart");
		firstFeaturedProductAddToWishlist.click();
		System.out.println("First Featured Product is successfully added to wishlist");
		firstFeaturedProductCompare.click();
		System.out.println("First Featured Product is successfully added to comparison list");
	}
}
